      ...
      switch (salesType?.value) {
        ...
        case 'Month Wise':
          setBarGraphData({
            ...
            datasets: [
              {
                data: [284849, 364859, 958493, 847594, 941939, 794763, 604847, 364859, 958493, 794763, 284849, 941939],
                backgroundColor: [BLUE, GREEN, RED, BLUE],
                borderWidth: 1,
              },
            ],
  ...
  return (
    <div className="flex-1">
          ...
          <BlankCard
            ...
            body={
              <div>
                ...
                <div className="h-72">
                  <PieChart labels={pieGraphData.map((item) => item?.type)}
      ...
      <div class="grid grid-cols-12 gap-x-6 font-Roboto">
        ...
        {/* <div class="xxl:col-span-3 md:col-span-6 col-span-12">
          <BlankCard header={<h4 class="box-title font-bold">CHARTJS POLAR CHART</h4>} body={<div className="h-64"><PolarChart /></div>} />
        </div> */}
      </div>
    </div>
  );
